...
<div class="page-body">
    ...
    <a href="<?php echo base_url('admin/data_lokasi_presensi/tambah.php'); ?>" class="btn btn-primary"><span class="text"><i class="fa-solid fa-circle-plus"></i> Tambah Data</span></a>
