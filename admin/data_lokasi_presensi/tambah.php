...
if(isset($_POST['submit'])) {
    ...
    $radius = isset($_POST['radius']) && $_POST['radius'] !== '' ? (int) $_POST['radius'] : 0; // Beri nilai default jika kosong
        ...
        <class="page-body">
            ...
            <form action="<?= base_url('admin/data_lokasi_presensi/tambah.php') ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="radius"  value="<?php if(isset($_POST['radius'])) echo $_POST['radius'] ?>" required>
                </div>
