            ...
            <?php } else { ?>
                ...
                while ($lokasi = mysqli_fetch_array($result)): ?>
                    <tr>
                        ...
                        <td><span class="badge badge-pill bg-secondary text-black"><?= $lokasi['latitude'] ?></span>
                        </td>
                        <td><span class="badge badge-pill bg-secondary text-black"><?= $lokasi['longitude'] ?></span>
                        </td>
                        <td><?= $lokasi['radius'] ?></td>
